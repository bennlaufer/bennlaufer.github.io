...
│   ├── resume.astro            # Resume — responsive in-page presentation + direct PDF download
│   └── projects/
...
- The resume PDF is at `public/resume.pdf`; the responsive in-page content is structured in `src/data/resume.ts`
- Keep the structured resume content factually aligned with the downloadable PDF when updating either asset
